...
VALUES ('Mathematics', 'Study of numbers, equations, and geometry'),
...
INSERT INTO teacher (name, hireDate, subjectId)
VALUES ('Johan', '2015-08-15', 1), -- Mathematics
...
INSERT INTO student (name, age, gradeLevel, enrollmentDate)
VALUES ('Emil', 16, '10th', '2022-09-01'),
...
VALUES ('Mathematics 101', 'Mon 10:00 AM', 1, 1), -- Class for Mathematics (subject_id = 1) with Teacher 1
...
INSERT INTO grade (studentId, classId, grade, date)
VALUES (1, 1, 'A', '2024-11-01'), -- Elin in Algebra 101
...
ORDER BY FIELD(LEFT(schedule, 3), 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'), -- Sort by day
         STR_TO_DATE(SUBSTRING_INDEX(schedule, ' ', -2), '%h:%i %p'); -- sort by time;
...
-- Create procedures to update a students gradeLevel
DELIMITER //

CREATE PROCEDURE UpdateStudentGrade(
    IN p_studentId INT,
    IN newGradeLevel VARCHAR(10)
)
BEGIN
    UPDATE student
...
CALL UpdateStudentGrade(1, '11th');

SELECT *
FROM student
WHERE studentId = 1;

-- Create procedures to remove a student
DELIMITER ;
